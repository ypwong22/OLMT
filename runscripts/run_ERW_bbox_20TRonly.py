...
exeroot = '/gpfs/wolf2/cades/cli185/proj-shared/zdr/ERW/output/20241031_conus_ICB20TRCNPRDCTCBC_erw_pft1/bld/'
...
nyears_trans   =  3        #number of years for transient run 
                           #  If -1, the final year will be the last year of forcing data.
run_startyear  = 2000      #Starting year for transient run OR for SP run
...
case_options['surfdata_global'] = '/gpfs/wolf2/cades/cli185/proj-shared/zdr/ERW/output/UQ/20241031_conus_ICB20TRCNPRDCTCBC_erw_pft1/g00009/surfdata_00009.nc'
case_options['domain_global'] = '/gpfs/wolf2/cades/cli185/proj-shared/zdr/ERW/output/UQ/20241031_conus_ICB20TRCNPRDCTCBC_erw_pft1/g00009/domain.nc'
case_options['pftdyn_global'] = '/gpfs/wolf2/cades/cli185/proj-shared/zdr/ERW/ensemble_surfdata/pft1/landuse.timeseries_conus1D_erw_on_hist_simyr1850_c240712_ensemble_8.nc'
...
case_options['finidat'] = "'/gpfs/wolf2/cades/cli185/proj-shared/zdr/ERW/output/20241018_conus_ICB20TRCNPRDCTCBC_erw_pft1/run/20241018_conus_ICB20TRCNPRDCTCBC_erw_pft1.elm.r.2000-01-01-00000.nc'"
if (use_erw):
