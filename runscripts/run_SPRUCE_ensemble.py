...
parm_list='parm_list_SPRUCE'       #parameter list file 
np_ensemble = 384  #number of ensemble numbers to run in parallel (NOTE:  Baseline limited to 500)
nsamples= 1920

#Output variables to postprocess ensemble
postproc_vars=['NPP','NPP_pft','HR','NEE','TOTVEGC_ABG_pft','TLAI_pft','SR','FCH4','CH4PROD']
