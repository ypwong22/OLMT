...
mettype = 'isimip'             #Site or reanalysis product to use (site, gswp3, crujra)
...
use_cpl_bypass = False     #Use Coupler bypass for meteorology
...
case_options['metdir'] = '/gpfs/wolf2/cades/cli185/proj-shared/ywo/E3SM/inputdata/atm/datm7/atm_forcing.ISIMIP.DonghuiXu.2024/gfdl-esm4/historical'
if (use_erw):
